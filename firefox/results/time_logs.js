document.querySelector('title').appendChild(document.createTextNode(browser.runtime.getManifest().name + ' - Time logs'));
document.addEventListener('DOMContentLoaded', function() {

    var time_logs;
    var timer = browser.extension.getBackgroundPage().timer; // shortcut for formatting time
    browser.storage.sync.get('time_logs', function(obj) {
        if (obj.time_logs) {
